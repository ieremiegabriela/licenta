...
<head>
    ...
    <script type="text/javascript" src="/modules/feed/view.js"></script>
    <script type="text/javascript" src="/modules/feed/page/js/body.js"></script>
</head>

<?php
require_once("{$_SERVER['DOCUMENT_ROOT']}/modules/feed/page/body.php");
?>
