            ...
            <div id="messageContainer" class="d-flex flex-column-reverse overflow-auto card-list p-2 custom-border-radius flex-grow-1">
                ...
                ?>
                                    <div class="message-container d-flex flex-column justify-content-end align-items-end mb-1 ms-auto">
                                        ...
                                        <span class="message-status text-secondary small px-1 <?php echo ($output['data']['lastSenderMessageId'] === $element['id'] ? "last-message" : "d-none"); ?>">
                                            <?php echo date("H:i", strtotime($element['addedOn'])); ?>&nbsp;·&nbsp;<?php echo $element['status']; ?>
                                        </span>
                                    </div>
                                <?php
                                    break;
                                ...
                                ?>
                                    <div class="message-container d-flex flex-column justify-content-start align-items-start mb-1 me-auto">
                                        ...
                                        <span class="message-status text-secondary small px-1 <?php echo ($output['data']['lastRecipientMessageId'] === $element['id'] ? "last-message" : "d-none") ?>">
                                            <?php echo date("H:i", strtotime($element['addedOn'])); ?>
                                        </span>
                                    </div>
                        <?php
                                    break;
                    ...
                    case false:
                        ...
                        <div class="message-container d-flex flex-column justify-content-center align-items-center mb-1 ms-auto me-auto">
                            <div class="empty-chat message bg-info-subtle p-2 custom-border-radius border">No messages yet. Be the first to start the conversation!</div>
                        </div>
                <?php
                        break;
                endswitch;
